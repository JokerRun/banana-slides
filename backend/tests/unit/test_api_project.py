...
class TestProjectCreate:
    ...
    def test_create_project_idea_mode(self, client):
        ...
        response = client.post(
            "/api/projects",
            json={"creation_type": "idea", "idea_prompt": "生成一份关于AI的PPT"},
        )
    ...
    def test_create_project_missing_type(self, client):
        """测试缺少creation_type参数"""
        response = client.post("/api/projects", json={"idea_prompt": "测试"})
    ...
    def test_create_project_invalid_type(self, client):
        ...
        response = client.post(
            "/api/projects",
            json={"creation_type": "invalid_type", "idea_prompt": "测试"},
        )
...
class TestProjectUpdate:
    ...
    def test_update_project_status(self, client, sample_project):
        ...
        project_id = sample_project["project_id"]
        response = client.put(
            f"/api/projects/{project_id}", json={"status": "GENERATING"}
        )
    ...
    def test_update_project_name(self, client, sample_project):
        ...
        project_id = sample_project["project_id"]
        response = client.put(
            f"/api/projects/{project_id}", json={"project_name": "  新历史页名称  "}
        )
    ...
    def test_update_project_name_rejects_blank(self, client, sample_project):
        ...
        project_id = sample_project["project_id"]
        response = client.put(
            f"/api/projects/{project_id}", json={"project_name": "   "}
        )
    ...
    def test_update_project_name_clear_with_null(self, client, sample_project):
        ...
        set_response = client.put(
            f"/api/projects/{project_id}", json={"project_name": "自定义名称"}
        )
        assert_success_response(set_response)

        clear_response = client.put(
            f"/api/projects/{project_id}", json={"project_name": None}
        )
    ...
    def test_update_project_name_rejects_too_long(self, client, sample_project):
        ...
        project_id = sample_project["project_id"]
        response = client.put(
            f"/api/projects/{project_id}", json={"project_name": "a" * 256}
        )
